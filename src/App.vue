    ...
    <div id="container">
      ...
      <div id="visit_container" v-show="visible['방명록']">
        <div class="visitors_group">
          <div id="input_pack">
            <div class="input_box">
              <input id="vistors_msg" type="text" v-model="input_msg" placeholder="작성란"
                v-on:keyup.enter="addmsg(input_msg)" ref="inputtag" @focus="makeblank()" @blur="notfocused()">
            </div>
  ...
  data(){
    return{
        ...
        images :[
            ...
            {title: '청와대', location: 'Seoul(KR)', description: '', url: require('./assets/img/section5.jpg')},
        ],
        images_description : ['This is the A-cup of my jeju travel. It was really tough day but this photo gives us kind of coziness. This might be pure function of photograph.',
                              'This might be my favorite shots through GR3. Although this photo is crop, it has really sharp details presenting dynamic waves and the color balance is surely warm.',
                              'While snowing hardly, the spark was initally started pushing me way out home. I could see them most beautiful scape of gyeongbukgong.',
                              'It was a tough day. I was expecting the touches that palace would give me but it was just crowded people in the palace',
                              '2022.05.10 청와대 is realsed to public.',],
        writings : [
